const toggle = document.querySelector(".toggle"),
  ...
  toggleOpen = document.querySelector(
    "div.toggle > i.fa-solid.fa-ellipsis-vertical.open"
  ),
  toggleClose = document.querySelector(
    "div.toggle > i.fa-solid.fa-xmark.close"
  );
